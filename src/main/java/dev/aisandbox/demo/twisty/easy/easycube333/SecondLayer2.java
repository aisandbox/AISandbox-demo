...
@Slf4j
public class SecondLayer2 implements Solver3x3x3Algorithm {

  @Override
  public boolean isValid(String state) {
    // If we've already got the first two edges - ignore
    if (state.matches("....Y........RRRRR...GGGGGG...OO.OOO....B.BBBWWWWWWWWW")) return false;
  ...
  public String getMoves(String state) throws SolverException {
    log.info("Trying to move Green/Orange edge to second layer {}", state);
    EdgePosition p = Finder.findEdge(state, 'G', 'O');
